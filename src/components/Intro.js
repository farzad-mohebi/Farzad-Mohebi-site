...
function Intro() {
  ...
  return (
    <div
      className="py-12 md:py-16 lg:py-18 2xl:py-48 px-6 md:px-8 lg:px-12 xl:px-20 2xl:px-36 max-w-screen-2xl w-full mx-auto h-screen flex items-center"
      id="home"
    >
      <ParticleBg
      ...
      <div className="flex flex-col">
        ...
        >
          ...
          <div className="text-white text-6xl md:text-8xl font-extrabold font-mono">
            Farzad Mohebi<span className="bg-clip-text text-orange-500">.</span>
          </div>
          <nav className="justify-between items-center relative text-base md:text-xl lg:text-2xl 2xl:text-3xl pt-3 xl:py-3 bg-clip-text text-orange-500 font-mono">
            <ScrollLink
              activeClass="active"
              to="about-me"
              spy={true}
          ...
          <div className="flex flex-row pt-4 2xl:py-8 font-mono">
            <div className="flex flex-row text-2xl">
              <a
                href="https://github.com/farzdmhb"
                target="_blank"
                rel="noreferrer"
              >
                <svg
                  ...
                  class="bi bi-github"
                  viewBox="0 0 16 16"
                  className="hover:fill-orange opacity-80"
                >
            ...
            <div className="pl-5 flex flex-row text-2xl">
              <a
                href="https://www.linkedin.com/in/frzdmhb/"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <div className="pl-5 flex flex-row text-2xl">
              <a
                href="https://twitter.com/floatyvariable"
                target="_blank"
                rel="noreferrer"
              >
                <svg
