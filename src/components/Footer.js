...
const linkStyle =
  "hidden md:block cursor-pointer text-gray-400 hover:text-orange-500 uppercase"
            ...
            {!props.isContact || props.isContact === undefined ? (
              <div>
                {props.paginationAnim || props.paginationAnim === undefined ? (
                  <div
                    className="w-full text-3xl md:text-4xl lg:text-6xl font-bold"
                ...
                <div className="flex sm:mt-2 md:mt-4 lg:mt-8 flex-col md:flex-row md:justify-between">
                  ...
                  props.paginationAnim === undefined ? (
                    <div
                      className="w-full md:w-2/3 text-gray-400 text-xs md:text-base hidden md:block"
                      data-sal="slide-right"
                      data-sal-easing="ease"
                      data-sal-duration="1000"
                    >
                  ...
                  <div className="w-44 pt-6 md:pt-0">
                    ...
                    props.paginationAnim === undefined ? (
                      <a
                        href="/contact/"
                        className="font-semibold text-base hover:bg-orange-500 bg-trueGray-800 rounded-md text-white outline-none justify-center text-center shadow px-4 py-2 md:px-4 md:py-3 lg:px-10 lg:py-3 flex items-center"
                        data-sal="slide-left"
                        data-sal-easing="ease"
                        data-sal-duration="1000"
                      >
